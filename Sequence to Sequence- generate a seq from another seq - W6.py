...
def get_rate(d_model, step_num, warmup_step):
    # Calculate the learning rate based on the equation provided
    arg1 = step_num**-0.5  # decay
    arg2 = step_num * (warmup_step**-1.5)  # warm-up
...
checkdir = "./checkpoints/transformer"
